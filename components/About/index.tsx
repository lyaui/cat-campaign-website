...
function About() {
  ...
  return (
    <section id={currentRouter.hash} className='pb-11' data-aos='fade-up'>
      <Container>
        <div className='flex items-start justify-between gap-4 md:gap-[64px]'>
          <Image
            draggable={false}
            src={sloganEnImg}
            width={sloganEnImgSize.width * 0.35}
            height={sloganEnImgSize.height * 0.35}
            alt='slogan en'
          />
          <div className='w-auto p-4 md:py-10 md:px-12 bg-white border-[5px] border-primary rounded-tl-[80px] rounded-br-[80px] shadow-[-5px_5px_0_0_rgba(69,39,160,1)] md:shadow-[-15px_20px_0_0_rgba(69,39,160,1)]'>
            <>
              <h3 className='hidden md:block md:heading-1 text-center md:mb-8'>
                護航台灣幸福經濟 從照顧每一隻貓咪開始
              </h3>
              <h3 className='md:hidden heading-5 text-center whitespace-pre-line mb-2.5'>
                {`護航台灣幸福經濟\n從照顧每一隻貓咪開始`}
              </h3>
            </>
